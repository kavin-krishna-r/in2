                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Stack spacing={1}>
                    ...
                    <FormControl sx={{ width: '100%' }} error={Boolean(touched.date && errors.date)}>
                      <input
                        type="date"
                        value={values.date || ''} // Ensure a valid string format for the date
                        ...
                        style={{
                          ...
                          fontSize: '1rem',
                          borderRadius: '4px',
                          border: `1px solid ${touched.date && errors.date ? 'red' : '#ccc'}`,
                        }}
                      />
                      {touched.date && errors.date && (
                        <span style={{ color: 'red', fontSize: '0.8rem' }}>{errors.date}</span>
                      )}
                    </FormControl>
                  </Stack>
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Stack spacing={1}>
                    ...
                    <FormControl sx={{ width: '100%' }} error={Boolean(touched.due_date && errors.due_date)}>
                      <input
                        type="date"
                        value={values.due_date || ''} // Ensure a valid string format for the date
                        ...
                        style={{
                          ...
                          fontSize: '1rem',
                          borderRadius: '4px',
                          border: `1px solid ${touched.due_date && errors.due_date ? 'red' : '#ccc'}`,
                        }}
                      />
                      {touched.due_date && errors.due_date && (
                        <span style={{ color: 'red', fontSize: '0.8rem' }}>{errors.due_date}</span>
                      )}
                    </FormControl>
                  </Stack>
                        ...
                        <>
                          <TableContainer>
                            <Table sx={{ minWidth: 650 }}>
                              ...
                              <TableBody>
                                {InvoiceDetail1?.map((item, index) => (
                                  <TableRow key={item.id}>
                                    <TableCell>{InvoiceDetail1.indexOf(item) + 1}</TableCell>
                                    <InvoiceItem
                                      key={item.id}
                                      id={item.id}
                                      index={index}
