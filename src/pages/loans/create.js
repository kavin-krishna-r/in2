...
import InvoiceItem from 'sections/apps/loan/InvoiceItem';
import AddressModal from 'sections/apps/loan/AddressModal';
import InvoiceModal from 'sections/apps/loan/InvoiceModal';
                  ...
                  <Stack spacing={1}>
                    ...
                    <FormControl sx={{ width: '100%' }}>
                      ...
                      >
                        ...
                        <MenuItem value="Paid">Pending</MenuItem>
                        <MenuItem value="Unpaid">Approved</MenuItem>
                  ...
                  <Stack spacing={1}>
                    ...
                    <FormControl sx={{ width: '100%' }} error={Boolean(touched.due_date && errors.due_date)}>
                      <TextField
                        ...
                        InputLabelProps={{ shrink: true }}
                        helperText={touched.due_date && errors.due_date ? errors.due_date : ''}
                      />
                    </FormControl>
                  </Stack>
                            ...
                            <Table sx={{ minWidth: 650 }}>
                              <TableHead>
                                <TableRow>
                                  ...
                                  <TableCell>Institue Name</TableCell>
