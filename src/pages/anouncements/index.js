...
import { DeleteTwoTone, EditTwoTone, EyeTwoTone, FileDoneOutlined, InfoCircleOutlined, LockOutlined, LinkOutlined } from '@ant-design/icons';
...
const InstituteCell = ({ row }) => {
    ...
    return (
        <Stack direction="row" spacing={1.5} alignItems="center">
            {/* <Avatar alt="Avatar" size="sm" src={avatarImage(`./avatar-${!values.avatar ? 1 : values.avatar}.png`)} /> */}
            <Stack spacing={0}>
                <Typography variant="subtitle1">{values.customer_name} Test Anouncement</Typography>
                {/* <Typography variant="caption" color="textSecondary">
          {values.email}
        </Typography> */}
            </Stack>
...
// Action Cell
const ActionCell = (row, setGetInvoiceId, setInvoiceId, navigation, theme, handleClickOpen) => {
    return (
...
const List = () => {
    ...
    const handleClickOpen = () => setOpen(!openModal)
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                className: 'cell-center',
                disableSortBy: true,
                Cell: ({ row }) => ActionCell(row, setGetInvoiceId, setInvoiceId, navigation, theme, handleClickOpen)
            }
        ],
        // eslint-disable-next-line react-hooks/exhaustive-deps
        []
        ...
        <>
            <Grid container direction={matchDownSM ? 'column' : 'row'} spacing={2} sx={{ pb: 2 }}>
                <Grid item md={8}>
                    <Grid container direction="row" spacing={2}>
                        <MainCard title="Create Anouncement">
                            <Grid container spacing={2} alignItems="center">
                                ...
                                <Grid item xs={12} lg={6}>
                                    <Stack spacing={0.5}>
                                        ...
                                        <TextField fullWidth placeholder="Enter Description" />
                                    </Stack>
                                </Grid>
                                <Grid item xs={12} lg={6}>
                                    <Stack spacing={0.5}>
          ...
          >
            ...
            <Dialog open={openModal} onClose={handleCloseModal}>
                <Box sx={{ p: 1, py: 1.5 }}>
                    <DialogTitle>Edit Anouncement</DialogTitle>
                    <DialogContent>
